...
namespace SmallestSubarray
{
     ...
     */
    std::tuple<int, int> FindSmallestSubarrayCoveringSubset(
     ...
     * \return a tuple of the start and end indices of the smallest subarray
     */
    std::tuple<int, int> FindSmallestSubarraySequentiallyCoveringSubset(
        const std::vector<std::string>& paragraph,
        const std::vector<std::string>& keywords);
}

// ----------------------------------------------------------------------------
inline std::tuple<int, int> SmallestSubarray::FindSmallestSubarrayCoveringSubset(
    const std::vector<std::string>& paragraph,
    const std::vector<std::string>& keywords)
{
...
// ----------------------------------------------------------------------------
inline std::tuple<int, int> SmallestSubarray::FindSmallestSubarraySequentiallyCoveringSubset(
    const std::vector<std::string>& paragraph,
    const std::vector<std::string>& keywords)
{
