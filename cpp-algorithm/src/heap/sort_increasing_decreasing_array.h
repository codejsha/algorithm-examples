#ifndef CPP_ALGORITHM_SORT_INCREASING_DECREASING_ARRAY_H
#define CPP_ALGORITHM_SORT_INCREASING_DECREASING_ARRAY_H
...
namespace IncreasingDecreasingArray
{
     ...
     * \return sorted array
     */
    std::vector<int> SortIncreasingDecreasingArray(
        const std::vector<int>& arr);
}

// ----------------------------------------------------------------------------
inline std::vector<int> IncreasingDecreasingArray::SortIncreasingDecreasingArray(
    const std::vector<int>& arr)
{
