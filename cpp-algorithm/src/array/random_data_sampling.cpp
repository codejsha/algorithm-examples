...
std::vector<int> RandomDataSampling::OfflineRandomSampling(const int k, std::vector<int>& arr)
{
...
std::vector<int> RandomDataSampling::ComputeRandomPermutation(const int n)
{
