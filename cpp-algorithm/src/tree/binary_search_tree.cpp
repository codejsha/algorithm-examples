...
int main()
{
    ...
    const auto result1 = tree.InorderTreeWalk();
    std::cout << "Inorder tree walk (recursive):" << std::endl;
    util::PrintSequence(result1);

    const auto result2 = tree.RecursiveTreeSearch(seq.back());
    std::cout << "Tree search (recursive):" << std::endl;
    std::cout << result2->value << std::endl;

    const auto result3 = tree.IterativeTreeSearch(seq.back());
    std::cout << "Tree search (iterative):" << std::endl;
    std::cout << result3->value << std::endl;

    const auto result4 = tree.GetMinimum();
    std::cout << "Minimum:" << std::endl;
    std::cout << result4->value << std::endl;

    const auto result5 = tree.GetMaximum();
    std::cout << "Maximum:" << std::endl;
    std::cout << result5->value << std::endl;

    const auto result6 = tree.GetSuccessor(15);
    std::cout << "Successor:" << std::endl;
    std::cout << result6->value << std::endl;

    const auto result7 = tree.GetPredecessor(15);
    std::cout << "Predecessor:" << std::endl;
    std::cout << result7->value << std::endl;

    //std::cout << "Delete all:" << std::endl;
    //for (auto& element : seq)
    //{
    //    tree.Delete(element);
    //    util::PrintSequence(tree.InorderTreeWalk());
    //}
}
