...
namespace LowestCommonAncestor
{
     ...
     */
    const BinaryTree::Node<int>* FindLowestCommonAncestor(
     ...
     * \return the lowest common ancestor of the two nodes
     */
    const BinaryTree::ExtendedNode<int>* FindLowestCommonAncestor2(
 ...
 */
inline LowestCommonAncestor::Status LcaHelper(
    const BinaryTree::Node<int>* tree,
    const BinaryTree::Node<int>* node1,
    const BinaryTree::Node<int>* node2)
{
...
// ----------------------------------------------------------------------------
inline const BinaryTree::Node<int>* LowestCommonAncestor::FindLowestCommonAncestor(
    const BinaryTree::Node<int>* tree,
    const BinaryTree::Node<int>* node1,
    const BinaryTree::Node<int>* node2)
{
...
// ----------------------------------------------------------------------------
inline const BinaryTree::ExtendedNode<int>* LowestCommonAncestor::FindLowestCommonAncestor2(
    const BinaryTree::ExtendedNode<int>* tree,
    const BinaryTree::ExtendedNode<int>* node1,
    const BinaryTree::ExtendedNode<int>* node2)
