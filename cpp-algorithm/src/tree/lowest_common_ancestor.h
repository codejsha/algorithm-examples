...
namespace LowestCommonAncestor
{
    ...
    auto FindLowestCommonAncestor(const BinaryTree::Node<int>* tree, const BinaryTree::Node<int>* node1,
    ...
    /// @param node2 the second node
    /// @return the lowest common ancestor of the two nodes
    auto FindLowestCommonAncestor2(const BinaryTree::ExtendedNode<int>* tree,
                                   const BinaryTree::ExtendedNode<int>* node1,
                                   const BinaryTree::ExtendedNode<int>* node2) -> const BinaryTree::ExtendedNode<int>*;
}
