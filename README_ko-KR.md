...
- 단순 링크드 리스트에서 오른쪽 원형 시프트 구현하기 (Implement cyclic right shift for a singly linked list (CyclicallyRightShiftList)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/linked_list)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/linked_list))
...
- 리스트의 피벗 구현하기 (List pivoting (ListPivoting)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/linked_list)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/linked_list))
- 링크드 리스트 짝수-홀수 병합하기 (Merge even and odd nodes in linked list (MergeEvenOddLinkedList)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/linked_list)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/linked_list))
...
- 링크드 리스트가 회문인지 확인하기 (Palindrome list (IsListPalindrome)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/linked_list)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/linked_list))
...
- 이진 트리의 테두리 구하기 (Binary tree exterior (CreateExteriorNodeList)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/tree)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/tree))
- 전위, 중위 순회를 사용하여 이진 탐색 트리 복원하기 (Construct binary tree from preorder and inorder traversal (ConstructTreeFromPreorderInorder)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/tree)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/tree))
- 마커를 포함하는 전위 순회를 사용하여 이진 탐색 트리 복원하기 (Construct binary tree from preorder with marker (ConstructTreeFromMarkerPreorder)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/tree)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/tree))
- 이진 트리의 리프 노드로 구성된 리스트 만들기 (Leaf node list (CreateLeafNodeList)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/tree)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/tree))
...
- 오른쪽 형제 트리 구하기 (Populate right sibling (PopulateRightSibling)): [c++](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/src/tree)([test](https://github.com/codejsha/algorithm-examples/tree/main/cpp-algorithm/test/tree))
